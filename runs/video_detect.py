...
# Load model
model = YOLO('detect/yolov8s_traffic_sign_detection/weights/best.pt') # ADRESİ DÜZENLE !
labels = model.names
...
# Load video
video_path = "detect/yolov8s_traffic_sign_detection/inference/test.mp4" # ADRESİ DÜZENLE !
